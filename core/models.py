...
class Item(models.Model):
    ...
    display_image_one = models.ImageField( blank=True,null=True)
    display_image_two = models.ImageField( blank=True,null=True)
    display_image_three = models.ImageField( blank=True,null=True)
